...
@property (nullable, class, nonatomic, copy) NSString *rexxarHttpScheme API_AVAILABLE(ios(11.0));
@property (nullable, class, nonatomic, copy) NSString *rexxarHttpsScheme API_AVAILABLE(ios(11.0));
